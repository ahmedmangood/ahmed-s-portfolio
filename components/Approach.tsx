  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 mx-auto px-8">
        <Card
          title={t("approachOneTitle")}
          description={t("approachOneDescription")}
          icon={<AceternityIcon order={t("phaseOne")} />}
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title={t("approachTwoTitle")}
          description={t("approachTwoDescription")}
          icon={<AceternityIcon order={t("phaseTwo")} />}
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title={t("approachThreeTitle")}
          description={t("approachThreeDescription")}
          icon={<AceternityIcon order={t("phaseThree")} />}
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-6 py-3 text-2xl font-bold text-purple backdrop-blur-3xl">
          {order}
        </span>
      </button>
    </div>
